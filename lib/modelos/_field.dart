...
class DateTimeField extends StatelessWidget {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (Theme.of(context).platform == TargetPlatform.iOS) {
      final DateTime? selectedDateTime = await showCupertinoPicker(context, initialDateTime);
      ...
      if (modesWithDate.contains(mode)) {
        final DateTime? selectedDate = await showMaterialDatePicker(context, initialDateTime);
      ...
      if (modesWithTime.contains(mode)) {
        final TimeOfDay? selectedTime = await showMaterialTimePicker(context, initialDateTime);
      ...
      child: GestureDetector(
        ...
        child: Focus(
          ...
          child: InputDecorator(
            ...
            child: widget.text == null ? null : Text(widget.text!, style: widget.textStyle),
          ),
        ),
      ),
    );
