...
import '_inventario.dart';

class SubUbicacionesPage extends StatefulWidget {
  final CollectionReference locationCollection;
  final String title;
  final int sedeIndex;
  final int ubicacionIndex;
  const SubUbicacionesPage({
    super.key,
    required this.title,
  ...
  @override
  State<SubUbicacionesPage> createState() => SubUbicacionesPageState();
}

class SubUbicacionesPageState extends State<SubUbicacionesPage> {
  ...
  @override
  void initState() {
    subtitulo = 'Sede ${sedes![widget.sedeIndex].nombre}';
    isDataLoad = false;
    init();
    // getSeriales();
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: scaffoldSubUbicacionesPagekey,
      extendBody: true,
      appBar: appBarInst(
        subtitulo,
        0,
      ...
      body: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: (size.width < size.height)
              ? Center(
                  child: ContadorBar(
                    key: contadorSubUbicacionesBarkey,
                    locations: (subUbicaciones != null) ? subUbicaciones! : null,
                ...
                child: Center(
                  child: SizedBox(
                    ...
                    child: WaterfallFlow.builder(
                                ...
                                builder: (context) {
                                  return InventarioPage(
                                    locationCollection: FirebaseFirestore.instance
                                        ...
                                        .doc(subUbicaciones![index].subUbicacion!.key)
                                        .collection('inventario'),
                                    title: subUbicaciones![index].nombre,
                                    sedeIndex: widget.sedeIndex,
                                    ubicacionIndex: widget.ubicacionIndex,
                                    subUbicacionIndex: index,
                                  );
                                },
                              ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: Center(
                                      child: Container(
                                        ...
                                        child: (subUbicaciones![index].imagen!.contains('shapes'))
                                            ? Image.asset(
                                                'assets/shapes.png',
                                                width: width * 0.9,
                                                height: 100,
                                            ...
                                            : Image(
                                                image: NetworkImage(subUbicaciones![index].imagen!),
                                                width: width * 0.9,
                                                height: 100,
                                              ),
                                        // const Placeholder(),
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: Text(
                                            ...
                                            '${subUbicaciones![index].location.capitalize()} - ${subUbicaciones![index].nombre}',
                                            softWrap: true,
                      ...
                      itemCount: subUbicaciones!.length,
                    ),
                  ),
                ),
              )
